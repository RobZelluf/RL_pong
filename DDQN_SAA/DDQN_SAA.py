...
class DDQN_SAA(object):
    def __init__(self, env, player_id=1, size=200, model_info=None, fc1_size=64):
        ...
        self.network2 = Q_CNN(self.state_space, self.action_space, size, fc1_size=fc1_size)

        self.optimizer1 = optim.Adam(self.network1.parameters(), lr=1e-3)
        self.optimizer2 = optim.Adam(self.network2.parameters(), lr=1e-3)
    ...
    def _do_network_update(self):
        ...
        loss1, loss2 = self.compute_losses(action_batch, non_final_mask, non_final_next_states, reward_batch, state_batch)
